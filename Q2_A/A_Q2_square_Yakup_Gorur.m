...
title('Output Signal and Reference Signal versus Time');
...
hold on;
plot(t,r,'LineWidth',2);
title('Control Signal and Reference versus Time');
...
title('P, I, D versus Time');
legend('P','I','D');
xlabel('Time'), ylabel('P, I, D');
grid;
